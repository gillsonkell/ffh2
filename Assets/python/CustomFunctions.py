...
#     City Processing
    ...
    for i in range (CyMap().numPlots()):
      ...
      for ii in range(pPlot.getNumUnits()):
        ...
        if pUnit.getDuration() > 0 and ( pUnit.getUnitClassType() == gc.getInfoTypeForString('UNITCLASS_RECRUIT') or pUnit.getUnitClassType() == gc.getInfoTypeForString('UNITCLASS_WARRIOR') or pUnit.getUnitClassType() == gc.getInfoTypeForString('UNITCLASS_AXEMAN') ):
          pUnit.setDuration(0)
