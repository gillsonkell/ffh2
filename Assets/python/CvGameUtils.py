...
#           return 0
  ...
  def cannotTrain(self,argsList):
    ...
    if eUnit == gc.getInfoTypeForString('UNIT_ARQUEBUS'):
      if pPlayer.countNumBuildings(gc.getInfoTypeForString('BUILDING_CRAFTSMEN_GUILD')) * 3 <= pPlayer.getUnitClassCount(gc.getInfoTypeForString('UNITCLASS_ARQUEBUS')):
        return True
    ...
    if eUnit == gc.getInfoTypeForString('UNIT_WYRMLING'):
      if pCity.getCulture(pCity.getOwner()) < 50000:
        return True

    if eUnit == gc.getInfoTypeForString('UNIT_KELLER'):
      if 'OBELISK' not in sCityInfo:
        sCityInfo['OBELISK'] = 1
      if sCityInfo['OBELISK'] > 0 or pCity.getCulture(pCity.getOwner()) < 40000:
        return True
  ...
  def cannotConstruct(self,argsList):
    ...
    if eBuilding == gc.getInfoTypeForString('BUILDING_DRAGON_NEST'):
      if pCity.getCulture(pCity.getOwner()) < 50000:
        return True
